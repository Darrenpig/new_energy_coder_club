...
## 目录索引
- 上位机组: [上位机组.md](./上位机组.md)
- 上位机组_运球机构: [上位机组_运球机构.md](./上位机组_运球机构.md)
- 机械组: [Readme](./机械组/Readme.md) | 方案: [R1发球机构开发](./机械组/R1发球机构开发.md) · [R2人形机器人开发](./机械组/R2人形机器人开发.md) · [舵轮AGV开发](./机械组/舵轮AGV开发.md)
- 机械组_Step图纸: [打开文件夹](./机械组_Step图纸/)
- 电控组: [Readme](./电控组/Readme.md) | 文档: [520电机参数.docx](./电控组/520电机参数.docx) · [PM-R3用户手册V1.2](./电控组/PM-R3用户手册V1.2)
- 电控组_unitreeM8010驱动: [打开文件夹](./电控组_unitreeM8010驱动/)
- 气动装置选型与控制原理: [Readme](./气动装置选型与控制原理/Readme.md) | 资料: [AirTac气动元件计算与选型.pdf](./气动装置选型与控制原理/AirTac气动元件计算与选型.pdf) · [Festo气动培训资料.pdf](./气动装置选型与控制原理/Festo气动培训资料.pdf) · [SMC气动原理-电磁阀篇.pdf](./气动装置选型与控制原理/SMC气动原理-电磁阀篇.pdf)
- 算法组: [算法组.md](./算法组.md)
- 硬件组: [硬件组.md](./硬件组.md)
- 运营组: [运营组.md](./运营组.md)
- 采购组: [采购组.md](./采购组.md)
- 队伍结构: [队伍结构.md](./队伍结构.md)
- 竞赛规则: [主题与规则V3.md](./竞技赛主题与规则V3.md) · [技能挑战赛规则V2.pdf](./第二十四届全国大学生机器人竞赛ROBOCON“飞身上篮”技能挑战赛规则V2.pdf) · [竞技赛规则V4.pdf](./第二十四届全国大学生机器人竞赛ROBOCON“飞身上篮”竞技赛规则V4.pdf)
- Logo: [NEC_Logo_Vector.svg](./NEC_Logo_Vector.svg)

---
# 文档导航
- [NEC简报](#nec-briefing)
- [项目进程](#project-progress)
- [核心成员进度](#core-members)
- [设计方案讨论](#design-discussion)
- [财务开源进度](#finance-progress)
- [感谢链接](#thanks-links)
- [感谢开源](#thanks-open)
...
## 250715
### 顺利完赛 部分成员到场合影留念
![输入图片说明](./机械组/a959ac655d540345d5ace97a55651419_.jpg)
![输入图片说明](./机械组/微信图片_20250406194703.jpg)
## 250713
...
#### 250601-250630 ✅缓慢搭建R1R2
#### 250702 ✅考试结束，开始紧跟NEC团队进度
#### 250712 ✅仿照binbin气动装置，在R2内布置气动方案，完成得分动作-传球
---
###  @许子涵涵 
#### 250520-250715 稳步推进R2进度，到场协助R1、R2搭建
---
###  @李硕  【25赛季硬件核心成员】
#### A板焊接完成 4块
#### 各组线路焊接完成
...
###  @彭柯尹 【25赛季机械小组长/R1】
#### 250323 江理工交流机械会议
#### 250328 完成铝方切割，和机械组部署
#### 250331 部署组员完成基本的零件设计
#### 250401 装配，完成初稿
#### 250504 根据图纸，和组员理清气缸搓轮齿轮方案，并部署下一阶段任务
#### 250506 安装仿真软件，推进机械上位机共研工作
#### 250508 底盘的重新制作和开始气泵与轨道的角度调节设计
...
![Debug_lsusb](./机械组/R2胶轮安装测试.jpg)
---
[返回顶部](#readme-top)
<a id="design-discussion"></a>
# 设计方案讨论😲✨
##### https://a360.co/4b5QcO7
##### Fusion360 人形机器人结构讨论
##### 机械设计：手部结构；轮腿结构；
##### 机电设计：微控制器与关节电机；
##### 机械设计：[轮足方案](机械组/R2型材调节.jpg)以上述图片为概念模板，底部采用轮足结构，去掉下肢，上肢机械臂参考灵犀이图纸，并暂以3爪为设计构想 

---
# 财务开源进度
<a id="finance-progress"></a>
[返回顶部](#readme-top)
